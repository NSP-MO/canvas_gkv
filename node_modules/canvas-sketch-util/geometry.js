...
var squaredDistance = require('canvas-sketch-util/lib/vec2').squaredDistance;
...
module.exports.clipSegmentToCircle = require('canvas-sketch-util/lib/clip/clip-segment-to-circle');
module.exports.clipLineToCircle = require('canvas-sketch-util/lib/clip/clip-line-to-circle');
